  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-[400px] bg-white border border-zinc-200 rounded-3xl p-8 shadow-xl shadow-zinc-900/5 animate-fade-up">
          
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">Bem-vindo de volta! 👋</h1>
            <p className="text-sm text-zinc-500 mt-2">Acesse sua conta para colocar a máquina para trabalhar.</p>
          </div>
          ...
          <div className="relative flex items-center mb-6">
            ...
            <span className="shrink-0 text-xs font-medium text-zinc-400 px-4 uppercase tracking-wider">ou entre com e-mail</span>
            <div className="flex-grow border-t border-zinc-200"></div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-zinc-100 text-center">
            <p className="text-sm text-zinc-500">
              Ainda não tem uma conta? <NavLink to="/register" className="font-bold text-indigo-600 hover:text-indigo-700">Começar Grátis</NavLink>
            </p>
          </div>
        </div>
      </main>
